...
public class CartApi {
    ...
    public Response addToCart(int productId, int quantity){
        ...
        // Log the cookie domains to check for any mismatches
        response.getDetailedCookies().asList().forEach(cookie -> {
            System.out.println("Cookie: " + cookie.getName() + " | Domain: " + cookie.getDomain());
        });
